...
mod tests {
    ...
    fn test_monthly_limit_error_classification() {
        ...
        let response_body = r#"{"__type":"com.amazon.aws.codewhisperer#ThrottlingException","message":"Maximum Request reached for this month.","reason":"MONTHLY_REQUEST_COUNT"}"#;
    ...
    fn test_service_unavailable_exception_classification() {
        ...
        let response_body = r#"{"__type":"com.amazon.aws.codewhisperer#ServiceUnavailableException","message":"The service is temporarily unavailable. Please try again later."}"#;
        let response = Response::builder()
            .status(500)
            .body(response_body)
            .unwrap()
    ...
    fn test_500_error_without_specific_message_not_retried() {
        ...
        let response_body =
            r#"{"__type":"com.amazon.aws.codewhisperer#InternalServerException","message":"Some other error"}"#;
        let response = Response::builder()
            .status(500)
            .body(response_body)
            .unwrap()
